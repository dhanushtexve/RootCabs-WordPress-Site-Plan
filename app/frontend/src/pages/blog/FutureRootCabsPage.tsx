...
const storyFacts = [
  { label: 'Focus', value: 'Smarter and safer travel' },
  { label: 'Coverage', value: 'More than ten cities in Tamil Nadu' },
  { label: 'Key area', value: 'Customer and driver experience' },
  { label: 'Direction', value: 'Area by area improvement' },
];
      ...
      <div className="mx-auto max-w-screen-xl px-4 py-10 md:py-12">
        <div className="grid gap-8 lg:grid-cols-[minmax(0,1.72fr)_minmax(300px,0.78fr)]">
                  ...
                  <div className="flex aspect-[16/9] min-h-[280px] items-center justify-center px-6 text-center md:min-h-[340px]">
                    <div className="max-w-lg space-y-3">
                      <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full border border-slate-200 bg-white shadow-sm">
                        <Sparkles className="h-7 w-7 text-[#1E2A6E]" />
                      </div>
                      <p className="font-semibold text-slate-800">Featured image space reserved</p>
                      <p className="text-sm leading-6 text-slate-600">
                        Upload the future vision image here when it is ready. For media updates, contact{' '}
          ...
          <aside className="space-y-6 lg:sticky lg:top-6 lg:self-start">
            ...
            <Card className="border-slate-200 shadow-sm">
              <CardContent className="p-5">
                <h2 className="font-heading text-xl font-bold text-slate-950">Vision Snapshot</h2>
