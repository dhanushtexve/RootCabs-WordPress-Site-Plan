...
export const businessSolutions = [
  {
    ...
    description: "Streamline your company's transportation with Root Cabs corporate accounts. Dedicated account manager, monthly billing, employee ride management, and priority booking.",
    features: ["Centralized billing", "Employee ride management portal", "Priority booking", "Dedicated account manager", "Custom SLAs", "Monthly reports & analytics"],
  },
  {
    slug: "hotel-partners",
    title: "Hotel Partner Program",
    description: "Partner with Root Cabs to offer seamless transportation for your hotel guests. Earn commission on every booking while providing world-class service to your guests.",
    features: ["Guest booking integration", "Commission on bookings", "Branded booking widget", "24/7 availability", "Multi-language drivers", "Airport shuttle service"],
  },
  {
    slug: "travel-agents",
    title: "Travel Agent Partnership",
    description: "Expand your travel packages with reliable ground transportation. Root Cabs provides special rates for travel agents with bulk booking discounts and dedicated support.",
    features: ["Bulk booking discounts", "API integration", "White-label options", "Tour package support", "Multi-city coverage", "Priority support line"],
  },
];
