...
type VueOptions = Omit<MarkdownToJSX.Options, "createElement" | "wrapperProps" | "renderRule" | "overrides"> & {
	...
	renderRule?: (next: () => VueChild[] | VueChild | null, node: MarkdownToJSX.ASTNode, renderChildren: (children: MarkdownToJSX.ASTNode[]) => VueChild[] | VNode, state: MarkdownToJSX.State) => VueChild[] | VueChild | null;
...
export { slugify, sanitizer, parser, Markdown as default, compiler, astToJSX, VueOverrides, VueOverride, VueOptions, RuleType, MarkdownToJSX, MarkdownProvider, MarkdownOptionsKey, Markdown };
