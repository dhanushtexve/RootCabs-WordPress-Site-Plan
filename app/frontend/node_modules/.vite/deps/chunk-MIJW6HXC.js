...
function createContextScope(scopeName, createContextScopeDeps = []) {
  ...
  __name(createContext32, "createContext");
...
function createCollection(name) {
  ...
  __name2(useCollection, "useCollection");
  return [
...
function composeEventHandlers(originalEventHandler, ourEventHandler, { checkForDefaultPrevented = true } = {}) {
  return __name3(function handleEvent(event) {
...
var DirectionProvider = __name8((props) => {
...
__name8(useDirection, "useDirection");
...
//# sourceMappingURL=chunk-MIJW6HXC.js.map
