...
__name3(useStateMachine, "useStateMachine");
var Presence = __name3((props) => {
...
function usePresence(present) {
  ...
  useLayoutEffect2(() => {
    if (node) {
      ...
      const handleAnimationEnd = __name3((event) => {
      ...
      const handleAnimationStart = __name3((event) => {
...
__name3(usePresence, "usePresence");
...
__name3(useStableComposedRefs, "useStableComposedRefs");
function getAnimationName(styles) {
  return (styles == null ? void 0 : styles.animationName) || "none";
}
__name3(getAnimationName, "getAnimationName");
...
__name3(getElementRef, "getElementRef");
...
//# sourceMappingURL=chunk-QGUU72HV.js.map
