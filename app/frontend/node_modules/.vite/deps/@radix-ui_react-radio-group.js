...
function RadioProvider(props) {
  ...
  const [userInteractionCount, onUserInteraction] = React4.useReducer(
    (count) => count + 1,
    0
  );
  ...
  const context = {
    ...
    bubbleInput,
    setBubbleInput,
    onCheck: __name3(() => onCheck == null ? void 0 : onCheck(), "onCheck")
  };
...
__name3(RadioProvider, "RadioProvider");
var TRIGGER_NAME = "RadioTrigger";
var RadioTrigger = React4.forwardRef(
  __name3(function RadioTrigger2({ __scopeRadio, onClick, ...radioProps }, forwardedRef) {
    const {
      checked,
      disabled,
      value,
...
var RadioIndicator = React4.forwardRef(
  __name3(function RadioIndicator2(props, forwardedRef) {
...
var RadioBubbleInput = React4.forwardRef(
  __name3(function RadioBubbleInput2({ __scopeRadio, onClick, ...props }, forwardedRef) {
    const {
      control,
      checked,
      required,
    ...
    const shouldStopClickPropagationRef = React4.useRef(false);
    const prevCheckedRef = React4.useRef(checked);
    const prevUserInteractionCountRef = React4.useRef(userInteractionCount);
    React4.useEffect(() => {
    ...
    const defaultCheckedRef = React4.useRef(checked);
    return (0, import_jsx_runtime2.jsx)(
      Primitive.input,
      {
        type: "radio",
...
var RadioGroup = React22.forwardRef(
  __name3(function RadioGroup2(props, forwardedRef) {
    const {
      __scopeRadioGroup,
      name,
      form,
    ...
    const composedRefs = useComposedRefs(forwardedRef, setControl);
    const initialValueRef = React22.useRef(value);
    React22.useEffect(() => {
...
__name3(RadioGroupItemProvider, "RadioGroupItemProvider");
var RadioGroupItemTrigger = React22.forwardRef(__name3(function RadioGroupItemTrigger2(props, forwardedRef) {
  ...
  React22.useEffect(() => {
    const handleKeyDown = __name3((event) => {
      if (ARROW_KEYS.includes(event.key)) {
        isArrowKeyPressedRef.current = true;
      }
    }, "handleKeyDown");
    const handleKeyUp = __name3(() => isArrowKeyPressedRef.current = false, "handleKeyUp");
...
var RadioGroupItem = React22.forwardRef(
  __name3(function RadioGroupItem2(props, forwardedRef) {
...
var RadioGroupItemBubbleInput = React22.forwardRef(__name3(function RadioGroupItemBubbleInput2(props, forwardedRef) {
...
var RadioGroupIndicator = React22.forwardRef(
  // blank line to reduce diff noise
  __name3(function RadioGroupIndicator2(props, forwardedRef) {
