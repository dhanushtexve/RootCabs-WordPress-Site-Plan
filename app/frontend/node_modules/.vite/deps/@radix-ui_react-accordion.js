...
var Accordion = React2.forwardRef(
  // blank line to reduce diff noise
  __name2(function Accordion2(props, forwardedRef) {
...
var AccordionImplSingle = React2.forwardRef(
  // blank line to reduce diff noise
  __name2(function AccordionImplSingle2(props, forwardedRef) {
    const {
      value: valueProp,
      defaultValue,
      onValueChange = __name2(() => {
      }, "onValueChange"),
      collapsible = false,
...
var AccordionImplMultiple = React2.forwardRef(__name2(function AccordionImplMultiple2(props, forwardedRef) {
  const {
    value: valueProp,
    defaultValue,
    onValueChange = __name2(() => {
...
var AccordionImpl = React2.forwardRef(
  __name2(function AccordionImpl2(props, forwardedRef) {
    ...
    const handleKeyDown = composeEventHandlers(props.onKeyDown, (event) => {
      ...
      const moveNext = __name2(() => {
        nextIndex = triggerIndex + 1;
        if (nextIndex > endIndex) {
          nextIndex = homeIndex;
        }
      }, "moveNext");
      const movePrev = __name2(() => {
        nextIndex = triggerIndex - 1;
...
var AccordionItem = React2.forwardRef(
  __name2(function AccordionItem2(props, forwardedRef) {
...
var AccordionHeader = React2.forwardRef(
  // blank line to reduce diff noise
  __name2(function AccordionHeader2(props, forwardedRef) {
...
var AccordionTrigger = React2.forwardRef(
  // blank line to reduce diff noise
  __name2(function AccordionTrigger2(props, forwardedRef) {
...
var AccordionContent = React2.forwardRef(
  // blank line to reduce diff noise
  __name2(function AccordionContent2(props, forwardedRef) {
