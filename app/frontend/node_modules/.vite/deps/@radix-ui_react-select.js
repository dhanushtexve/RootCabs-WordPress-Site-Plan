...
import {
  useSize
} from "./chunk-PXOFCYJF.js";
import {
  useCallbackRef
} from "./chunk-LGJEOL5N.js";
import {
  createCollection,
  useId
} from "./chunk-TC32ANPD.js";
import {
  useControllableState
} from "./chunk-GFXJ4L5M.js";
import {
  useDirection
} from "./chunk-6VN5Z3CU.js";
import {
  Presence,
  composeEventHandlers,
  createContextScope,
  useLayoutEffect2
} from "./chunk-BTKGBHJZ.js";
import {
  Primitive,
  dispatchDiscreteCustomEvent
} from "./chunk-QPXEGYMJ.js";
import {
  createSlot,
  useComposedRefs
} from "./chunk-X4EUXIVQ.js";
import {
  require_react_dom
...
var Arrow = React5.forwardRef(
  __name4(function Arrow2(props, forwardedRef) {
...
var PopperAnchor = React6.forwardRef(
  __name5(function PopperAnchor2(props, forwardedRef) {
...
var PopperContent = React6.forwardRef(
  __name5(function PopperContent2(props, forwardedRef) {
    ...
    const { refs, floatingStyles, placement, isPositioned, middlewareData } = useFloating({
      ...
      whileElementsMounted: __name5((...args) => {
      ...
      middleware: [
        ...
        size3({
          ...detectOverflowOptions,
          apply: __name5(({ elements, rects, availableWidth, availableHeight }) => {
...
var PopperArrow = React6.forwardRef(
  __name5(function PopperArrow2(props, forwardedRef) {
...
__name5(isNotNull, "isNotNull");
var transformOrigin = __name5((options) => ({
...
__name5(getSideAndAlignFromPlacement, "getSideAndAlignFromPlacement");
...
__name7(usePrevious, "usePrevious");
...
function SelectProvider(props) {
  ...
  const initialValueRef = React19.useRef(value);
  React19.useEffect(() => {
    ...
    if (associatedForm instanceof HTMLFormElement) {
      const reset = __name9(() => setValue(initialValueRef.current), "reset");
  ...
  const handleNativeOptionAdd = React19.useCallback((option) => {
    setNativeOptionsSet((prev) => new Set(prev).add(option));
  }, []);
  const handleNativeOptionRemove = React19.useCallback((option) => {
  ...
  return (0, import_jsx_runtime7.jsx)(Popper, { ...popperScope, children: (0, import_jsx_runtime7.jsx)(SelectProviderImpl, { scope: __scopeSelect, ...context, children: (0, import_jsx_runtime7.jsx)(Collection.Provider, { scope: __scopeSelect, children: (0, import_jsx_runtime7.jsx)(
...
__name9(SelectProvider, "SelectProvider");
var Select = __name9((props) => {
...
var SelectTrigger = React19.forwardRef(
  __name9(function SelectTrigger2(props, forwardedRef) {
    ...
    const handleOpen = __name9((pointerEvent) => {
      if (!isDisabled) {
    ...
    return (0, import_jsx_runtime7.jsx)(PopperAnchor, { asChild: true, ...popperScope, children: (0, import_jsx_runtime7.jsx)(
      Primitive.button,
      {
        type: "button",
        role: "combobox",
...
var SelectValue = React19.forwardRef(
  __name9(function SelectValue2(props, forwardedRef) {
    ...
    return (0, import_jsx_runtime7.jsx)(
      Primitive.span,
      {
        ...
        children: (0, import_jsx_runtime7.jsx)(React19.Fragment, { children: showPlaceholder ? placeholder : children }, showPlaceholder ? "placeholder" : "value")
      }
    );
  }, "SelectValue")
);
var SelectIcon = React19.forwardRef(
  __name9(function SelectIcon2(props, forwardedRef) {
...
var SelectPortal = __name9((props) => {
...
var SelectContent = React19.forwardRef(
  __name9(function SelectContent2(props, forwardedRef) {
...
var SelectContentFragment = React19.forwardRef(__name9(function SelectContentFragment2(props, forwardedRef) {
...
var SelectContentImpl = React19.forwardRef(
  // blank line to reduce diff noise
  __name9(function SelectContentImpl2(props, forwardedRef) {
    ...
    React19.useEffect(() => {
      if (content) {
        ...
        const handlePointerMove = __name9((event) => {
          var _a, _b;
          pointerMoveDelta = {
        ...
        const handlePointerUp = __name9((event) => {
    ...
    React19.useEffect(() => {
      const close = __name9(() => onOpenChange(false), "close");
...
var SelectItemAlignedPosition = React19.forwardRef(__name9(function SelectItemAlignedPosition2(props, forwardedRef) {
...
var SelectPopperPosition = React19.forwardRef(__name9(function SelectPopperPosition2(props, forwardedRef) {
  const {
    __scopeSelect,
    align = "start",
...
var SelectViewport = React19.forwardRef(
  __name9(function SelectViewport2(props, forwardedRef) {
...
var SelectGroup = React19.forwardRef(
  __name9(function SelectGroup2(props, forwardedRef) {
...
var SelectLabel = React19.forwardRef(
  __name9(function SelectLabel2(props, forwardedRef) {
...
var SelectItem = React19.forwardRef(
  __name9(function SelectItem2(props, forwardedRef) {
    const {
      __scopeSelect,
      value,
      disabled = false,
...
var SelectItemText = React19.forwardRef(
  __name9(function SelectItemText2(props, forwardedRef) {
...
var SelectItemIndicator = React19.forwardRef(
  // blank line to reduce diff noise
  __name9(function SelectItemIndicator2(props, forwardedRef) {
...
var SelectScrollUpButton = React19.forwardRef(__name9(function SelectScrollUpButton2(props, forwardedRef) {
  ...
  useLayoutEffect2(() => {
    if (contentContext.viewport && contentContext.isPositioned) {
      ...
      __name9(handleScroll22, "handleScroll");
...
var SelectScrollDownButton = React19.forwardRef(__name9(function SelectScrollDownButton2(props, forwardedRef) {
...
var SelectScrollButtonImpl = React19.forwardRef(__name9(function SelectScrollButtonImpl2(props, forwardedRef) {
...
var SelectSeparator = React19.forwardRef(
  // blank line to reduce diff noise
  __name9(function SelectSeparator2(props, forwardedRef) {
...
var SelectArrow = React19.forwardRef(
  __name9(function SelectArrow2(props, forwardedRef) {
    const { __scopeSelect, ...arrowProps } = props;
    const popperScope = usePopperScope(__scopeSelect);
    const contentContext = useSelectContentContext(ARROW_NAME2, __scopeSelect);
    return contentContext.position === "popper" ? (0, import_jsx_runtime7.jsx)(PopperArrow, { ...popperScope, ...arrowProps, ref: forwardedRef }) : null;
  }, "SelectArrow")
);
var BUBBLE_INPUT_NAME = "SelectBubbleInput";
var SelectBubbleInput = React19.forwardRef(
  // blank line to reduce diff noise
  __name9(function SelectBubbleInput2({ __scopeSelect, ...props }, forwardedRef) {
...
__name9(shouldShowPlaceholder, "shouldShowPlaceholder");
function useTypeaheadSearch(onSearchChange) {
  ...
  const handleTypeaheadSearch = React19.useCallback(
    (key) => {
      ...
      __name9(function updateSearch(value) {
...
__name9(useTypeaheadSearch, "useTypeaheadSearch");
...
__name9(findNextItem, "findNextItem");
function wrapArray(array, startIndex) {
  return array.map((_, index2) => array[(startIndex + index2) % array.length]);
}
__name9(wrapArray, "wrapArray");
export {
